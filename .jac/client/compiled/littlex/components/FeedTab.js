/* Source: /Users/amirkhabaza/JacHacks2026/littlex/components/FeedTab.jac */
...
function FeedTab(props) {
  ...
  return __jacJsx("div", {}, [(() => {
    ...
    if (feedLoading) {
      __jac_view_kids_1.push(__jacJsx("div", {"className": "flex flex-col gap-4 p-4"}, [_jac.builtin.range(4).map(i => __jacJsx("div", {"className": "flex gap-3", "key": i}, [__jacJsx(Skeleton, {"className": "size-10 rounded-full"}, []), __jacJsx("div", {"className": "flex-1 space-y-2"}, [__jacJsx(Skeleton, {"className": "h-3 w-32"}, []), __jacJsx(Skeleton, {"className": "h-3 w-full"}, []), __jacJsx(Skeleton, {"className": "h-3 w-2/3"}, [])])]))]));
      return __jacJsx(null, {}, [__jac_view_kids_1]);
    }
    if ((tweets.length === 0)) {
      __jac_view_kids_1.push(__jacJsx(Empty, {"className": "py-16"}, [__jacJsx(EmptyHeader, {}, [__jacJsx(EmptyMedia, {"variant": "icon"}, [__jacJsx(Inbox, {}, [])]), __jacJsx(EmptyTitle, {}, ["Nothing here yet"]), __jacJsx(EmptyDescription, {}, ["Follow people or post something to fill your feed."])])]));
      return __jacJsx(null, {}, [__jac_view_kids_1]);
    }
