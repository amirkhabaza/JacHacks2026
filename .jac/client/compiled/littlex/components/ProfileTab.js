/* Source: /Users/amirkhabaza/JacHacks2026/littlex/components/ProfileTab.jac */
...
function ProfileTab(props) {
  ...
  return __jacJsx("div", {}, [__jacJsx("div", {"className": "h-36 w-full bg-gradient-to-br from-primary/50 via-primary/20 to-background"}, []), __jacJsx("div", {"className": "px-4 pb-3"}, [__jacJsx("div", {"className": "-mt-12 flex items-end justify-between"}, [__jacJsx(Avatar, {"className": "size-24 border-4 border-background shadow-lg"}, [__jacJsx(AvatarImage, {"src": profileAvatar, "alt": profileUsername}, []), __jacJsx(AvatarFallback, {"className": "text-2xl"}, [initial])])]), __jacJsx("div", {"className": "mt-3 font-display text-xl font-extrabold text-foreground"}, [displayUsername]), __jacJsx("div", {"className": "text-sm text-muted-foreground"}, [("@" + displayUsername)]), (() => {
    let __jac_view_kids = [];
    if (editingBio) {
      __jac_view_kids.push(__jacJsx("div", {"className": "mt-3 flex flex-col gap-2"}, [__jacJsx(Textarea, {"rows": 3, "placeholder": "Write your bio...", "value": bioText, "onChange": e => onBioChange(e.target.value)}, []), __jacJsx("div", {"className": "flex gap-2"}, [__jacJsx(Button, {"size": "sm", "className": "font-semibold", "onClick": () => onSaveBio()}, ["Save"]), __jacJsx(Button, {"size": "sm", "variant": "outline", "onClick": () => onCancelEditBio()}, ["Cancel"])])]));
    } else {
      __jac_view_kids.push(__jacJsx("p", {"className": "mt-3 text-sm text-foreground/90"}, [((myProfile && myProfile.profile.bio) ? myProfile.profile.bio : "No bio yet")]));
    }
    return __jacJsx(null, {}, [__jac_view_kids]);
  })(), __jacJsx("div", {"className": "mt-4 flex gap-5 text-sm"}, [__jacJsx("div", {"className": "flex items-center gap-1"}, [__jacJsx("span", {"className": "font-display font-bold text-foreground"}, [String(followingCount)]), __jacJsx("span", {"className": "text-muted-foreground"}, ["Following"])]), __jacJsx("div", {"className": "flex items-center gap-1"}, [__jacJsx("span", {"className": "font-display font-bold text-foreground"}, [String(followerCount)]), __jacJsx("span", {"className": "text-muted-foreground"}, [((followerCount === 1) ? "Follower" : "Followers")])]), __jacJsx("div", {"className": "flex items-center gap-1"}, [__jacJsx("span", {"className": "font-display font-bold text-foreground"}, [String(postCount)]), __jacJsx("span", {"className": "text-muted-foreground"}, [((postCount === 1) ? "Post" : "Posts")])])])]), __jacJsx("div", {"className": "border-t border-border"}, [(() => {
    let __jac_view_kids_1 = [];
    for (const tweet of myTweets) {
      __jac_view_kids_1.push(__jacJsx(TweetCard, {"key": _jac.builtin.jid(tweet), "tweet": tweet, "myUsername": profileUsername, "onLike": onLike, "onComment": onComment, "onDelete": onDelete, "onRepost": onRepost}, []));
    }
