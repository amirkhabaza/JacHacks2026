/* Source: /Users/amirkhabaza/JacHacks2026/littlex/components/TweetCard.jac */
import {__jacJsx, __jacSpawn} from "@jac/runtime";
import { Heart, MessageCircle, Trash2, Repeat2, Send } from "lucide-react";
...
import { AlertDialog, AlertDialogTrigger, AlertDialogContent, AlertDialogHeader, AlertDialogFooter, AlertDialogTitle, AlertDialogDescription, AlertDialogAction, AlertDialogCancel } from "./ui/alert_dialog.js";
...
function TweetCard(props) {
  ...
  let is_mine = (tweet.author_username === myUsername);
  let is_liked = tweet.likes.includes(myUsername);
  let like_count = tweet.likes.length;
  let comment_count = tweet.comments.length;
  ...
  let initial = (display_name ? display_name[0].toUpperCase() : "?");
  ...
  return __jacJsx("article", {"className": "lx-fade-up flex gap-3 border-b border-border px-4 py-3 transition-colors hover:bg-muted/30"}, [__jacJsx(Avatar, {"className": "size-10 shrink-0"}, [__jacJsx(AvatarImage, {"src": author_avatar, "alt": tweet.author_username}, []), __jacJsx(AvatarFallback, {}, [initial])]), __jacJsx("div", {"className": "min-w-0 flex-1"}, [__jacJsx("div", {"className": "flex items-center gap-1.5 text-sm"}, [__jacJsx("span", {"className": "font-display font-bold text-foreground truncate"}, [display_name]), __jacJsx("span", {"className": "text-muted-foreground truncate"}, [("@" + display_name)]), __jacJsx("span", {"className": "text-muted-foreground"}, ["·"]), __jacJsx("span", {"className": "text-muted-foreground"}, [date_str]), (() => {
    let __jac_view_kids = [];
    if (is_mine) {
      __jac_view_kids.push(__jacJsx("div", {"className": "ml-auto"}, [__jacJsx(AlertDialog, {}, [__jacJsx(AlertDialogTrigger, {"asChild": true}, [__jacJsx(Button, {"variant": "ghost", "size": "icon", "className": "size-7 text-muted-foreground hover:bg-destructive/10 hover:text-destructive"}, [__jacJsx(Trash2, {"size": 15}, [])])]), __jacJsx(AlertDialogContent, {}, [__jacJsx(AlertDialogHeader, {}, [__jacJsx(AlertDialogTitle, {}, ["Delete post?"]), __jacJsx(AlertDialogDescription, {}, ["This can't be undone and it will be removed from your profile and the feed."])]), __jacJsx(AlertDialogFooter, {}, [__jacJsx(AlertDialogCancel, {}, ["Cancel"]), __jacJsx(AlertDialogAction, {"className": "bg-destructive text-white hover:bg-destructive/90", "onClick": () => onDelete(_jac.builtin.jid(tweet))}, ["Delete"])])])])]));
    }
    return __jacJsx(null, {}, [__jac_view_kids]);
  })()]), __jacJsx("p", {"className": "mt-0.5 whitespace-pre-wrap break-words text-[0.95rem] leading-relaxed text-foreground"}, [tweet.content]), __jacJsx(TooltipProvider, {}, [__jacJsx("div", {"className": "mt-2 flex items-center gap-1 text-muted-foreground"}, [__jacJsx(Tooltip, {}, [__jacJsx(TooltipTrigger, {"asChild": true}, [__jacJsx(Button, {"variant": "ghost", "size": "sm", "className": "h-8 gap-1.5 rounded-full px-2 text-muted-foreground hover:bg-reply/10 hover:text-reply", "onClick": () => {
    setShowComments(!showComments);
  }}, [__jacJsx(MessageCircle, {"size": 16}, []), (() => {
    let __jac_view_kids_1 = [];
    if ((comment_count > 0)) {
      __jac_view_kids_1.push(__jacJsx("span", {"className": "text-xs"}, [String(comment_count)]));
    }
    return __jacJsx(null, {}, [__jac_view_kids_1]);
  })()])]), __jacJsx(TooltipContent, {}, ["Reply"])]), __jacJsx(Tooltip, {}, [__jacJsx(TooltipTrigger, {"asChild": true}, [__jacJsx(Button, {"variant": "ghost", "size": "sm", "className": "h-8 gap-1.5 rounded-full px-2 text-muted-foreground hover:bg-repost/10 hover:text-repost", "onClick": () => onRepost(_jac.builtin.jid(tweet), tweet.content, tweet.author_username)}, [__jacJsx(Repeat2, {"size": 16}, [])])]), __jacJsx(TooltipContent, {}, ["Repost"])]), __jacJsx(Tooltip, {}, [__jacJsx(TooltipTrigger, {"asChild": true}, [__jacJsx(Button, {"variant": "ghost", "size": "sm", "className": cn("h-8 gap-1.5 rounded-full px-2 hover:bg-like/10 hover:text-like", (is_liked ? "text-like" : "text-muted-foreground")), "onClick": () => onLike(_jac.builtin.jid(tweet))}, [__jacJsx(Heart, {"size": 16, "fill": (is_liked ? "currentColor" : "none")}, []), (() => {
    let __jac_view_kids_2 = [];
    if ((like_count > 0)) {
      __jac_view_kids_2.push(__jacJsx("span", {"className": "text-xs"}, [String(like_count)]));
    }
    return __jacJsx(null, {}, [__jac_view_kids_2]);
  })()])]), __jacJsx(TooltipContent, {}, [(is_liked ? "Unlike" : "Like")])])])]), (() => {
    let __jac_view_kids_3 = [];
    if (showComments) {
      __jac_view_kids_3.push(__jacJsx("div", {"className": "mt-3 flex flex-col gap-3 border-t border-border pt-3"}, [(() => {
        let __jac_view_kids_4 = [];
        for (const c of tweet.comments) {
          __jac_view_kids_4.push(__jacJsx("div", {"className": "flex gap-2", "key": c["created_at"]}, [__jacJsx(Avatar, {"className": "size-7 shrink-0"}, [__jacJsx(AvatarImage, {"src": ("https://i.pravatar.cc/150?u=fake@" + c["username"]), "alt": c["username"]}, []), __jacJsx(AvatarFallback, {"className": "text-[0.6rem]"}, [(c["username"] ? c["username"][0].toUpperCase() : "?")])]), __jacJsx("div", {"className": "rounded-2xl rounded-tl-sm bg-muted px-3 py-1.5"}, [__jacJsx("div", {"className": "text-xs font-semibold text-foreground"}, [c["username"]]), __jacJsx("div", {"className": "text-sm text-foreground/90"}, [c["content"]])])]));
        }
        return __jacJsx(null, {}, [__jac_view_kids_4]);
      })(), __jacJsx("div", {"className": "flex items-center gap-2"}, [__jacJsx(Input, {"placeholder": "Post your reply...", "value": commentText, "onChange": e => {
        setCommentText(e.target.value);
      }, "onKeyDown": e => {
        if (((e.key === "Enter") && commentText.trim())) {
          __jac_view_kids_3.push(onComment(_jac.builtin.jid(tweet), commentText));
          setCommentText("");
        }
      }}, []), __jacJsx(Button, {"size": "icon", "disabled": !commentText.trim(), "onClick": () => {
        if (commentText.trim()) {
          __jac_view_kids_3.push(onComment(_jac.builtin.jid(tweet), commentText));
          setCommentText("");
        }
      }}, [__jacJsx(Send, {"size": 16}, [])])])]));
    }
