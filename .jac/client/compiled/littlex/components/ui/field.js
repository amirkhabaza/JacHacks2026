/* Source: /Users/amirkhabaza/JacHacks2026/littlex/components/ui/field.jac */
...
let _fieldVariants = cva("data-[invalid=true]:text-destructive gap-2 data-[invalid=true]:text-destructive gap-2 group/field flex w-full", {"variants": {"orientation": {"vertical": "data-[invalid=true]:text-destructive gap-2-orientation-vertical flex-col *:w-full [&>.sr-only]:w-auto", "horizontal": "data-[invalid=true]:text-destructive gap-2-orientation-horizontal flex-row items-center *:data-[slot=field-label]:flex-auto has-[>[data-slot=field-content]]:items-start has-[>[data-slot=field-content]]:[&>[role=checkbox],[role=radio]]:mt-px", "responsive": "data-[invalid=true]:text-destructive gap-2-orientation-responsive flex-col *:w-full [&>.sr-only]:w-auto @md/field-group:flex-row @md/field-group:items-center @md/field-group:*:w-auto @md/field-group:*:data-[slot=field-label]:flex-auto @md/field-group:has-[>[data-slot=field-content]]:items-start @md/field-group:has-[>[data-slot=field-content]]:[&>[role=checkbox],[role=radio]]:mt-px"}}, "defaultVariants": {"orientation": "vertical"}});
function FieldSet(props) {
  let attrs = {...props};
  return __jacJsx("fieldset", Object.assign({}, attrs, {"data-slot": "field-set"}, {"className": cn("gap-4 has-[>[data-slot=checkbox-group]]:gap-3 has-[>[data-slot=radio-group]]:gap-3 gap-4 has-[>[data-slot=checkbox-group]]:gap-3 has-[>[data-slot=radio-group]]:gap-3 flex flex-col", props["className"])}), []);
}
function FieldLegend(props) {
  let attrs = {...props};
  let variant = (props["variant"] || "legend");
  return __jacJsx("legend", Object.assign({}, attrs, {"data-slot": "field-legend"}, {"data-variant": variant}, {"className": cn("mb-1.5 font-medium data-[variant=label]:text-sm data-[variant=legend]:text-base mb-1.5 font-medium data-[variant=label]:text-sm data-[variant=legend]:text-base", props["className"])}), []);
}
function FieldGroup(props) {
  let attrs = {...props};
  return __jacJsx("div", Object.assign({}, attrs, {"data-slot": "field-group"}, {"className": cn("gap-5 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4 gap-5 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4 group/field-group @container/field-group flex w-full flex-col", props["className"])}), []);
}
function Field(props) {
  let attrs = {...props};
  let orientation = (props["orientation"] || "vertical");
  let variantsFn = _fieldVariants;
  return __jacJsx("div", Object.assign({}, attrs, {"role": "group"}, {"data-slot": "field"}, {"data-orientation": orientation}, {"className": cn(variantsFn.call(null, {"orientation": orientation}), props["className"])}), []);
}
function FieldContent(props) {
  let attrs = {...props};
  return __jacJsx("div", Object.assign({}, attrs, {"data-slot": "field-content"}, {"className": cn("gap-0.5 gap-0.5 group/field-content flex flex-1 flex-col leading-snug", props["className"])}), []);
}
function FieldLabel(props) {
  return __jacJsx(Label, Object.assign({}, props, {"data-slot": "field-label"}, {"className": cn("has-data-checked:bg-primary/5 has-data-checked:border-primary/30 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10 gap-2 group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5 has-data-checked:bg-primary/5 has-data-checked:border-primary/30 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10 gap-2 group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5 group/field-label peer/field-label flex w-fit leading-snug", "has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col", props["className"])}), []);
}
function FieldTitle(props) {
  let attrs = {...props};
  return __jacJsx("div", Object.assign({}, attrs, {"data-slot": "field-label"}, {"className": cn("gap-2 text-sm font-medium group-data-[disabled=true]/field:opacity-50 gap-2 text-sm font-medium group-data-[disabled=true]/field:opacity-50 flex w-fit items-center leading-snug", props["className"])}), []);
}
function FieldDescription(props) {
  let attrs = {...props};
  return __jacJsx("p", Object.assign({}, attrs, {"data-slot": "field-description"}, {"className": cn("text-muted-foreground text-left text-sm [[data-variant=legend]+&]:-mt-1.5 text-muted-foreground text-left text-sm [[data-variant=legend]+&]:-mt-1.5 leading-normal font-normal group-has-data-horizontal/field:text-balance", "last:mt-0 nth-last-2:-mt-1", "[&>a:hover]:text-primary [&>a]:underline [&>a]:underline-offset-4", props["className"])}), []);
}
function FieldSeparator(props) {
  let attrs = {...props};
  return __jacJsx("div", Object.assign({}, attrs, {"data-slot": "field-separator"}, {"data-content": Boolean(props["children"])}, {"className": cn("-my-2 h-5 text-sm group-data-[variant=outline]/field-group:-mb-2 -my-2 h-5 text-sm group-data-[variant=outline]/field-group:-mb-2 relative", props["className"])}), [__jacJsx(Separator, {"className": "absolute inset-0 top-1/2"}, []), (props["children"] && __jacJsx("span", {"className": "text-muted-foreground px-2 bg-background relative mx-auto block w-fit", "data-slot": "field-separator-content"}, [props["children"]]))]);
}
function FieldError(props) {
  ...
  let content = useMemo(() => {
    ...
    let errorList = ((errors || [])).map(e => e);
    if (!errorList.length) {
      return null;
    }
    let uniqueMap = {};
    for (const error of errorList) {
      uniqueMap[(error && error.message)] = error;
    }
    let uniqueKeys = _jac.poly.call(Object, "keys", uniqueMap);
    let uniqueErrors = uniqueKeys.map(k => uniqueMap[k]);
    if ((uniqueErrors.length === 1)) {
      return (uniqueErrors[0] && uniqueErrors[0].message);
    }
    return __jacJsx("ul", {"className": "ml-4 flex list-disc flex-col gap-1"}, [(() => {
      let __jac_view_kids = [];
      for (const [index, error] of _jac.builtin.enumerate(uniqueErrors)) {
        if ((error && error.message)) {
          __jac_view_kids.push(__jacJsx("li", {"key": index}, [error.message]));
        }
      }
  ...
  return __jacJsx("div", Object.assign({}, attrs, {"role": "alert"}, {"data-slot": "field-error"}, {"className": cn("text-destructive text-sm text-destructive text-sm font-normal", props["className"])}), [content]);
}
