/* Source: /Users/amirkhabaza/JacHacks2026/littlex/components/ChannelsTab.jac */
...
import { Empty, EmptyHeader, EmptyMedia, EmptyTitle, EmptyDescription } from "./ui/empty.js";
...
function ChannelsTab(props) {
  ...
  return __jacJsx("div", {}, [(() => {
    ...
    if ((selectedChannel === null)) {
      __jac_view_kids.push(__jacJsx("div", {"className": "p-4"}, [__jacJsx(Button, {"className": "w-full font-semibold", "onClick": () => {
        setShowCreateChannel(true);
      }}, [__jacJsx(Plus, {"size": 16}, []), "Create Channel"])]));
      __jac_view_kids.push(__jacJsx(Dialog, {"open": showCreateChannel, "onOpenChange": v => {
        setShowCreateChannel(v);
      }}, [__jacJsx(DialogContent, {}, [__jacJsx(DialogHeader, {}, [__jacJsx(DialogTitle, {}, ["Create a channel"]), __jacJsx(DialogDescription, {}, ["Start a space for people to gather around a topic."])]), __jacJsx("div", {"className": "flex flex-col gap-4"}, [__jacJsx(Field, {}, [__jacJsx(FieldLabel, {"htmlFor": "lx-ch-name"}, ["Name"]), __jacJsx(Input, {"id": "lx-ch-name", "placeholder": "e.g. jac-builders", "value": newChannelName, "onChange": e => {
        setNewChannelName(e.target.value);
      }}, [])]), __jacJsx(Field, {}, [__jacJsx(FieldLabel, {"htmlFor": "lx-ch-desc"}, ["Description"]), __jacJsx(Textarea, {"id": "lx-ch-desc", "rows": 2, "placeholder": "What's this channel about? (optional)", "value": newChannelDescription, "onChange": e => {
        setNewChannelDescription(e.target.value);
      }}, [])])]), __jacJsx(DialogFooter, {}, [__jacJsx(Button, {"variant": "outline", "onClick": () => {
        setShowCreateChannel(false);
      }}, ["Cancel"]), __jacJsx(Button, {"className": "font-semibold", "disabled": !newChannelName.trim(), "onClick": () => {
        __jac_view_kids.push(onCreateChannel(newChannelName.trim(), newChannelDescription.trim()));
        setNewChannelName("");
        setNewChannelDescription("");
        setShowCreateChannel(false);
      }}, ["Create"])])])]));
      if (channelsLoading) {
        __jac_view_kids.push(__jacJsx("div", {"className": "flex flex-col gap-3 px-4"}, [_jac.builtin.range(4).map(i => __jacJsx(Skeleton, {"className": "h-20 w-full rounded-xl", "key": i}, []))]));
        return __jacJsx(null, {}, [__jac_view_kids]);
      }
      if ((channels.length === 0)) {
        __jac_view_kids.push(__jacJsx(Empty, {"className": "py-16"}, [__jacJsx(EmptyHeader, {}, [__jacJsx(EmptyMedia, {"variant": "icon"}, [__jacJsx(Hash, {}, [])]), __jacJsx(EmptyTitle, {}, ["No channels yet"]), __jacJsx(EmptyDescription, {}, ["Create one to get the conversation started."])])]));
        return __jacJsx(null, {}, [__jac_view_kids]);
      }
      for (const ch of channels) {
        __jac_view_kids.push(__jacJsx("div", {"className": "lx-fade-up mx-4 mb-3 flex cursor-pointer items-center gap-3 rounded-xl border border-border bg-card p-4 transition-colors hover:bg-muted/40", "key": _jac.builtin.jid(ch.channel), "onClick": () => onSelectChannel(_jac.builtin.jid(ch.channel))}, [__jacJsx("div", {"className": "flex size-11 shrink-0 items-center justify-center rounded-lg bg-primary/15 text-primary"}, [__jacJsx(Hash, {"size": 20}, [])]), __jacJsx("div", {"className": "min-w-0 flex-1"}, [__jacJsx("div", {"className": "font-display font-bold text-foreground truncate"}, [ch.channel.name]), (() => {
          let __jac_view_kids_1 = [];
          if (ch.channel.description) {
            __jac_view_kids_1.push(__jacJsx("div", {"className": "text-sm text-muted-foreground truncate"}, [ch.channel.description]));
          }
          return __jacJsx(null, {}, [__jac_view_kids_1]);
        })(), __jacJsx("div", {"className": "mt-1 flex items-center gap-1 text-xs text-muted-foreground"}, [__jacJsx(Users, {"size": 12}, []), __jacJsx("span", {}, [(String(ch.member_count) + ((ch.member_count === 1) ? " member" : " members"))])])]), (() => {
          let __jac_view_kids_2 = [];
          if (ch.is_member) {
            __jac_view_kids_2.push(__jacJsx(Badge, {"variant": "secondary", "className": "shrink-0"}, ["Joined"]));
          }
          return __jacJsx(null, {}, [__jac_view_kids_2]);
        })()]));
      }
    } else {
      __jac_view_kids.push(__jacJsx("div", {"className": "border-b border-border p-4"}, [__jacJsx(Button, {"variant": "ghost", "size": "sm", "className": "-ml-2 mb-2 gap-1 text-muted-foreground", "onClick": () => onBackToChannels()}, [__jacJsx(ArrowLeft, {"size": 16}, []), "Back"]), __jacJsx("div", {"className": "flex items-center gap-2"}, [__jacJsx("div", {"className": "flex size-10 shrink-0 items-center justify-center rounded-lg bg-primary/15 text-primary"}, [__jacJsx(Hash, {"size": 20}, [])]), __jacJsx("div", {"className": "min-w-0 flex-1"}, [__jacJsx("div", {"className": "font-display text-lg font-extrabold text-foreground truncate"}, [selectedChannel.channel.name]), __jacJsx("div", {"className": "flex items-center gap-1 text-xs text-muted-foreground"}, [__jacJsx(Users, {"size": 12}, []), __jacJsx("span", {}, [(String(selectedChannel.member_count) + ((selectedChannel.member_count === 1) ? " member" : " members"))])])]), (() => {
        let __jac_view_kids_3 = [];
        if (selectedChannel.is_member) {
          __jac_view_kids_3.push(__jacJsx(Button, {"variant": "outline", "size": "sm", "className": "shrink-0", "onClick": () => {
            if (selectedChannel) {
              __jac_view_kids_3.push(onLeaveChannel(_jac.builtin.jid(selectedChannel.channel)));
            }
          }}, ["Leave"]));
        } else {
          __jac_view_kids_3.push(__jacJsx(Button, {"size": "sm", "className": "shrink-0 font-semibold", "onClick": () => {
            if (selectedChannel) {
              __jac_view_kids_3.push(onJoinChannel(_jac.builtin.jid(selectedChannel.channel)));
            }
          }}, ["Join"]));
        }
        ...
        if (selectedChannel.channel.description) {
          __jac_view_kids_4.push(__jacJsx("p", {"className": "mt-2 text-sm text-foreground/80"}, [selectedChannel.channel.description]));
        }
        return __jacJsx(null, {}, [__jac_view_kids_4]);
      })()]));
      if (selectedChannel.is_member) {
        __jac_view_kids.push(__jacJsx(Composer, {"avatar": profileAvatar, "avatarAlt": profileUsername, "placeholder": ("Post in #" + selectedChannel.channel.name), "value": channelComposerText, "onChange": v => {
          setChannelComposerText(v);
        }, "onPost": () => {
          __jac_view_kids.push(onChannelPost(channelComposerText));
          setChannelComposerText("");
        }, "rows": 2, "buttonLabel": "Post", "showCharRing": false}, []));
      }
      if ((channelPosts.length === 0)) {
        __jac_view_kids.push(__jacJsx(Empty, {"className": "py-12"}, [__jacJsx(EmptyHeader, {}, [__jacJsx(EmptyMedia, {"variant": "icon"}, [__jacJsx(Hash, {}, [])]), __jacJsx(EmptyTitle, {}, ["No posts yet"]), __jacJsx(EmptyDescription, {}, [(selectedChannel.is_member ? "Be the first to post!" : "Join this channel to post!")])])]));
        return __jacJsx(null, {}, [__jac_view_kids]);
      }
      for (const tweet of channelPosts) {
        __jac_view_kids.push(__jacJsx(TweetCard, {"key": _jac.builtin.jid(tweet), "tweet": tweet, "myUsername": profileUsername, "onLike": onLike, "onComment": onComment, "onDelete": onDelete, "onRepost": onRepost}, []));
      }
    }
    return __jacJsx(null, {}, [__jac_view_kids]);
  })()]);
