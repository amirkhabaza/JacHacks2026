/* Source: /Users/amirkhabaza/JacHacks2026/littlex/components/WelcomeBanner.jac */
...
function WelcomeBanner(props) {
  ...
  return __jacJsx("div", {"className": "lx-fade-up relative m-4 overflow-hidden rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/15 via-primary/5 to-transparent p-5"}, [__jacJsx("div", {"className": "flex items-start gap-3"}, [__jacJsx("div", {"className": "flex size-10 shrink-0 items-center justify-center rounded-full bg-primary/15 text-primary"}, [__jacJsx(Sparkles, {"size": 20}, [])]), __jacJsx("div", {"className": "flex-1"}, [__jacJsx("div", {"className": "font-display text-lg font-extrabold text-foreground"}, ["Welcome to LITTLE-X"]), __jacJsx("ul", {"className": "mt-2 flex flex-col gap-1 text-sm text-muted-foreground"}, [__jacJsx("li", {"className": "flex items-center gap-2"}, [__jacJsx("span", {"className": "size-1.5 rounded-full bg-primary"}, []), "Post a thought to get started"]), __jacJsx("li", {"className": "flex items-center gap-2"}, [__jacJsx("span", {"className": "size-1.5 rounded-full bg-primary"}, []), "Use #hashtags to join trending topics"]), __jacJsx("li", {"className": "flex items-center gap-2"}, [__jacJsx("span", {"className": "size-1.5 rounded-full bg-primary"}, []), "Explore and follow people in Explore"])])]), __jacJsx(Button, {"variant": "ghost", "size": "icon", "className": "size-7 text-muted-foreground hover:text-foreground", "onClick": () => onDismiss()}, [__jacJsx(X, {"size": 16}, [])])])]);
}
