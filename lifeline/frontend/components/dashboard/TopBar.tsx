  ...
  return (
    <header className="flex flex-wrap items-center justify-between gap-x-4 gap-y-2 border-b border-border px-4 py-2.5 backdrop-blur">
      <div className="flex min-w-0 items-center gap-3">
        <div
          aria-hidden
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-primary/15 text-sm font-bold text-primary"
        >
          LL
        </div>
        <div className="min-w-0">
          ...
          <div className="truncate text-[11px] text-muted-foreground">
            {activeScenario ? scenarioTitle : "Verified crisis intelligence"} · graph is the source
            of truth
          </div>
        </div>
      </div>
